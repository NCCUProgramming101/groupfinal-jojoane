...
void setup(){
  ...
  //third game
   ...
   riverRule2 = loadImage("img/river_bg_rule2.png");
    ...
    bgm = minim.loadFile("sound/bg_music.mp3");
    loseGame = minim.loadFile("sound/loseGame.wav",256);
    winGame = minim.loadFile("sound/winGame.wav",256);
    bumpSound = minim.loadSample("sound/bump.aiff",256);
